迁移CUDA代码到SYCL或DPC++在本书中没有详细介绍。有一些可用的工具和资源可以做到这一点。迁移CUDA代码相对简单，因为它是一种基于内核的并行化方法。一旦用SYCL或DPC++编写，目标设备比单独支持CUDA增强了很多。针对NVIDIA GPU，新增强的程序仍然可以使用支持NVIDIA GPU的SYCL编译器。\par
